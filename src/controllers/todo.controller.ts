...
export class TodoController {
  ...
  async findById(@param.path.number('id') id: number): Promise<Todo> {
    return await this.todoRepository.findById(id as unknown as string);
  }
  ...
  async updateById(
    ...
    await this.todoRepository.updateById(id as unknown as string, todo);
  }
  ...
  async deleteById(@param.path.number('id') id: number): Promise<void> {
    await this.todoRepository.deleteById(id as unknown as string);
  }
}
